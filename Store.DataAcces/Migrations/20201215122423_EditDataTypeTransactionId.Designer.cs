...
namespace Store.DataAccess.Migrations
{
    ...
    [Migration("20201215122423_EditDataTypeTransactionId")]
    partial class EditDataTypeTransactionId
    {
            ...
            modelBuilder.Entity("Store.DataAccess.Entities.AuthorInPrintingEdition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AuthorId = 1,
                            PrintingEditionId = 1,
                            Date = new DateTime(2020, 12, 15, 14, 24, 22, 819, DateTimeKind.Local).AddTicks(3555)
                        });
                });
